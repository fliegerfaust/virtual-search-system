...
return array(
	 ...
	 * @type string
	 */
	'title' => 'VeroTour Admin Panel',

	/**
	 * The path to your model config fam_monitor_directory(fam, dirname)
	 *
	 * @type string
	 */
	 ...
	 *	)
	 */
	// 'menu' => array('depart_cities', 'countries', 'resorts', 'hotels'),
	'menu' => array(
		'Database' => array('depart_cities', 'countries', 'resorts', 'hotels', 'vt_constants'),
		'ACL' => array('users', 'roles', 'permissions'),
